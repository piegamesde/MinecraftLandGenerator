...
public class Server {
	 ...
	 *            default value is ["java", "-jar"]. Use this to specify JVM options (like more RAM etc.) or to enforce the usage of a
	 ...
	 * <li>If {@code worldPath} is {@code null} and no path could be retrieved from the {@code server.properties}, start the server to
